# 🌟 Ghassan AI (`Ghassan_v1_pro`) — Architectural & Technical Reference
...
├── ARCHITECTURE.md             # Visual architecture & technical documentation
├── README.md                   # Primary repo documentation & verified runbook
